...
# lora_path = "/home/cipher/code/LLaMA-Factory/output/qwen/Qwen1.5-72B-Chat/lora/sft3/checkpoint-100"
# kwargs = {}

# model_path = "/home/data/cipher/model/qwen/qwen1.5-72B-Chat-GPTQ-Int4"
# lora_path = "/home/cipher/code/LLaMA-Factory/output/qwen/Qwen1.5-72B-Chat-GPTQ-Int4/lora/sft3/checkpoint-100"
# kwargs = {"kv_cache_dtype": "fp8_e5m2", "quantization": "gptq"}

model_path = "/home/data/cipher/model/deepseek-ai/DeepSeek-V2-Lite-Chat"
lora_path = "/home/cipher/code/LLaMA-Factory/output/deepseek/DeepSeek-V2-Lite-Chat/lora/sft/checkpoint-120"
kwargs = {}
qwen72Chat = Qwen72ChatEngine(model_path, lora_path, **kwargs)
...
def main():
    ...
    while True:
        ...
        torch_gc()
        log.info(f"query: {query}, response: {response}")
    print("\n\n=============测试, 祝您生活愉快~=============\n\n")
